...
SS Lower_trianle_mat="./output/nonparallel_Lower_"+change_to_string(Size)+"_"+change_to_string(num_threads)+".mat";
...
SS Upper_trianle_mat="./output/nonparallel_Upper_"+change_to_string(Size)+"_"+change_to_string(num_threads)+".mat";
...
SS Perm_mat="./output/nonparallel_Perm_"+change_to_string(Size)+"_"+change_to_string(num_threads)+".mat";
...
int num_threads=change_to_int(argv[3]);
    ...
    NonParallel_LU_Decomposition(Size,Perm,Mat,Lower,Upper);
